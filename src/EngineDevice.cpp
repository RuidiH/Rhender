...
namespace cgf
{
  ...
  std::vector<const char *> EngineDevice::getRequiredExtensions()
  {
    ...
    {
      // Handle error. For example, throw an exception or return an empty vector.
      throw std::runtime_error("Failed to get the count of required instance extensions from SDL.");
    }
    ...
    {
      // Handle error. For example, throw an exception or return an empty vector.
      throw std::runtime_error("Failed to get the required instance extensions from SDL.");
    }
