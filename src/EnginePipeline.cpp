...
namespace cgf
{
    ...
    void EnginePipeline::CreateGraphicsPipeline(const char *vertexPath, const char *fragmentPath, const ShaderConfigInfo configInfo)
    {
        assert(
        ...
        CreateShaderModule(vertShaderCode, &vertexShaderModule);
        CreateShaderModule(fragShaderCode, &fragmentShaderModule);
    ...
    ShaderConfigInfo EnginePipeline::DefaultPipelineConfigInfo(uint32_t width, uint32_t height)
    {
